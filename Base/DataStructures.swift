...
/**
 Data structure for BrainDumps.
 */
struct BrainDumpStruct: Identifiable, Codable, Hashable {
    var id: UUID = UUID()
    var version: Int = 1
...
struct AverageMoodDataStruct: Codable, Hashable {
    var flatAll: BrainDumpStruct? = BrainDumpStruct()
    var allAll: BrainDumpStruct? = BrainDumpStruct()
    
    var flatMonth: BrainDumpStruct? = BrainDumpStruct()
    var allMonth: BrainDumpStruct? = BrainDumpStruct()
    
    var flatThreeMonths: BrainDumpStruct? = BrainDumpStruct()
    var allThreeMonths: BrainDumpStruct? = BrainDumpStruct()
    
    var flatSixMonths: BrainDumpStruct? = BrainDumpStruct()
    var allSixMonths: BrainDumpStruct? = BrainDumpStruct()
    
    var flatYear: BrainDumpStruct? = BrainDumpStruct()
    var allYear: BrainDumpStruct? = BrainDumpStruct()
}
