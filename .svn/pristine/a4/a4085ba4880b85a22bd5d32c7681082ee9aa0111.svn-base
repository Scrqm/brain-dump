...
final class HealthManager: ObservableObject {
    ...
    func makeHealthSnaps(data: DataStoreClass) async {
        ...
        var date: Date = getLastDate(brainDumps: data.brainDumps)
        let earliest: Date = getFirstDate(brainDumps: data.brainDumps)
    ...
    func processWeight(data: DataStoreClass) async -> Bool {
        ...
        let weightCorrelationsMoodUI: [CGFloat?] = getCorrelation(brainDumps: brainDumps, healthSnaps: healthSnaps, type: .weight)
        let weightDataUI: [CGFloat?] = getWeightData(brainDumps: brainDumps, healthSnaps: healthSnaps)
    ...
    func processSleep(data: DataStoreClass) async -> Bool {
        ...
        let sleepCorrelationsMoodUI: [CGFloat?] = getCorrelation(brainDumps: brainDumps, healthSnaps: healthSnaps, type: .sleep)
        let sleepDataUI: [CGFloat?] = getSleepData(brainDumps: brainDumps, healthSnaps: healthSnaps)
    ...
    func processEnergy(data: DataStoreClass) async -> Bool {
        ...
        let energyDataUI: [CGFloat?] = getEnergyData(brainDumps: brainDumps, healthSnaps: healthSnaps)
        let energyCorrelationsMoodUI: [CGFloat?] = getCorrelation(brainDumps: brainDumps, healthSnaps: healthSnaps, type: .energy)
    ...
    func processDistance(data: DataStoreClass) async -> Bool {
        ...
        let distanceDataUI: [CGFloat?] = getDistanceData(brainDumps: brainDumps, healthSnaps: healthSnaps)
        let distanceCorrelationsMoodUI: [CGFloat?] = getCorrelation(brainDumps: brainDumps, healthSnaps: healthSnaps, type: .distance)
    ...
    func processMenstrual(data: DataStoreClass) async -> Bool {
        ...
        let menstrualDataUI: [CGFloat?] = getMenstrualData(brainDumps: brainDumps, healthSnaps: healthSnaps)
