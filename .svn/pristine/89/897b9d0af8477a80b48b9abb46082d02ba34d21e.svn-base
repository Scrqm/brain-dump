        ...
        NavigationView {
            ScrollView {
                LazyVStack {
                    ...
                    GroupBox(label: Label("how_to_use_brainDump", systemImage: "info.circle").foregroundColor(themes[data.settings.theme].iconColor)) {
                        Group {
                            Divider()
                            VStack(alignment: .leading) {
                                Text(.init("help_how_to_use_brainDump_string"))
                                    .font(.subheadline)
                            }
                        }
                    }
                    ...
                    Group {
                        GroupBox(label: Label("controls", systemImage: "gearshape").foregroundColor(themes[data.settings.theme].iconColor)) {
                            Group {
                                ...
                                LazyVGrid(columns: gridItemLayout, alignment: .leading, spacing: themes[data.settings.theme].historyGridSpacing) {
                                    ...
                                    Label("add_event", systemImage: "star.square")
                                        .foregroundColor(.secondary)
                                        .font(.subheadline)
                                    Label("take_brainDump", systemImage: "plus.circle")
                                        .foregroundColor(.secondary)
                                        .font(.subheadline)
                            ...
                            Group {
                                Divider()
                                VStack(alignment: .leading) {
                                    Label("taking_brainDumps", systemImage: "plus.circle")
                                        .foregroundColor(themes[data.settings.theme].iconColor)
                                    Spacer()
                                    Text(.init("help_taking_brainDumps_string"))
                                        .font(.subheadline)
                                }
                            }
